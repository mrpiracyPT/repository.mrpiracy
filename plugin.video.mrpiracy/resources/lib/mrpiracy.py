...
# MrPiracy functionality
class mrpiracy:
    def __init__(self):
        # http://mrapi.xyz/
        self.API = base64.urlsafe_b64decode('aHR0cDovL21yYXBpLnh5ei8=')
        # http://mrapi.xyz/apinew/
        self.API_SITE = base64.urlsafe_b64decode('aHR0cDovL21yYXBpLnh5ei9hcGluZXcv')#aHR0cDovL21wYXBpLm1sL2FwaS8= http://mpapi.ml/api/
        # http://mrpiracy.gq/
    ...
    def login(self):
        ...
        if controlo.addon.getSetting('email') == '' or controlo.addon.getSetting('password') == '':
            ...
            try:
                ...
                resultado = controlo.abrir_url(self.API_SITE + 'login.php', post = postRequest, header = controlo.headers)
    ...
    def pesquisa(self, url):
        ...
        if 'page' not in url:
            ...
            # Check if last search is stored results
