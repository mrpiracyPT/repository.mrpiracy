...
from . import Database, dom_parser, controlo, utils
    ...
    def get(self, netloc, ua, timeout):
        try:
            ...
            if self.cookie is None:
                controlo.log('%s returned an error. Could not collect tokens.' % netloc)
            return self.cookie
        except Exception as e:
            controlo.log('%s returned an error. Could not collect tokens - Error: %s.' % (netloc, str(e)))
            return self.cookie
